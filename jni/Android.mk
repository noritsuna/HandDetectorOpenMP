...
OPENCV_MODULES:=contrib legacy ml stitching objdetect ts videostab video photo calib3d features2d highgui imgproc flann core androidcamera
OPENCV_3RDPARTY_COMPONENTS:=assetmanager tbb libjpeg libpng libtiff libjasper IlmImf
#OPENCV_CAMERA_MODULES:= native_camera_r2.2.0 native_camera_r2.3.3 native_camera_r3.0.1 native_camera_r4.0.0 native_camera_r4.0.3 native_camera_r4.1.1 native_camera_r4.2.0 native_camera_r4.3.0
OPENCV_CAMERA_MODULES:= native_camera_r4.2.0
...
#LOCAL_CFLAGS += -O3 -fopenmp -ftree-vectorize -mvectorize-with-neon-quad
#LOCAL_LDFLAGS +=-O3 -fopenmp -ftree-vectorize -mvectorize-with-neon-quad

LOCAL_MODULE    := HandDetectorOpenMP
LOCAL_SRC_FILES := HandDetectorNativeActivity.cpp HandDetector.cpp
